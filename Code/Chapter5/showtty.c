/* showtty.c
 * displays some current tty setting
 */
#include <stdio.h>
#include <stdlib.h>
#include <termios.h>
...
{
  ISIG,		"Enable signals",
  ICANON,	"Canonical upper/lower appearance",
...
/*
 * show the values of two of the flag sets_: c_iflag and c_flag
 * adding c_oflag and c_cflag is pretty routine - just and new
...
/*
 * check each bit pattern and dispaly descriptive title
 */
